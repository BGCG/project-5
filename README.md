...
* Push your most recent changes to your github repo by committing them by `git add .`, `git commit -m 'My commit message'` and then push them to the repo by pushing to the github repo `git push`.
