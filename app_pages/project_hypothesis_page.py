...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        f" in the model to meet the client's performance goal of 97% accuracy."
        F"We evaluated our hypotheses by adjusting adjust our hyperparameters (usage of the adam optimiser) and regularisation "
        ...
        f"Our hypothesis was validated as evaluation of the model with the test set yielded a 99.2% accuracy, which met our clients goals. "
